...
class ProfileFragment : Fragment() {
    ...
    private fun setupRows() {
        ...
        bindRow(binding.rowTheme, R.drawable.ic_palette, getString(R.string.row_theme), getString(R.string.row_theme_value))
        bindRow(binding.rowLanguage, R.drawable.ic_globe, getString(R.string.row_language), getString(R.string.row_language_value))
